...
class MobileLinkGeneratorSettings {
	...
	<input type='hidden' name='mobile_link_generator_option_name[favicon_ico_0]' id='favicon_ico_0' value='<php? echo isset( $this->mobile_link_generator_options['favicon_ico_0'] ) ? esc_attr( $this->mobile_link_generator_options['favicon_ico_0']) : ''; ?>'>
	}

	public function apple_touch_192x192_1_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_192x192_1]" id="apple_touch_192x192_1" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_192x192_1'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_192x192_1']) : ''
		);
	}

	public function apple_touch_57x57_2_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_57x57_2]" id="apple_touch_57x57_2" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_57x57_2'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_57x57_2']) : ''
		);
	}

	public function apple_touch_72x72_3_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_72x72_3]" id="apple_touch_72x72_3" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_72x72_3'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_72x72_3']) : ''
		);
	}

	public function apple_touch_76x76_4_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_76x76_4]" id="apple_touch_76x76_4" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_76x76_4'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_76x76_4']) : ''
		);
	}

	public function apple_touch_114x114_5_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_114x114_5]" id="apple_touch_114x114_5" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_114x114_5'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_114x114_5']) : ''
		);
	}

	public function apple_touch_120x120_6_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_120x120_6]" id="apple_touch_120x120_6" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_120x120_6'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_120x120_6']) : ''
		);
	}

	public function apple_touch_144x144_7_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_144x144_7]" id="apple_touch_144x144_7" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_144x144_7'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_144x144_7']) : ''
		);
	}

	public function apple_touch_152x152_8_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_152x152_8]" id="apple_touch_152x152_8" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_152x152_8'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_152x152_8']) : ''
		);
	}

	public function apple_touch_180x180_9_callback() {
		printf(
			'<input class="regular-text" type="text" name="mobile_link_generator_option_name[apple_touch_180x180_9]" id="apple_touch_180x180_9" value="%s">',
			isset( $this->mobile_link_generator_options['apple_touch_180x180_9'] ) ? esc_attr( $this->mobile_link_generator_options['apple_touch_180x180_9']) : ''
		);
	}

}
if ( is_admin() )
	$mobile_link_generator = new MobileLinkGenerator();
